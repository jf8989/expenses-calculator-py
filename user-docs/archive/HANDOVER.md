...
- **Phase 7 (Local Caching)**: COMPLETE (IndexedDB + Background Sync).
...
1. **Phase 8: Data Migration**: Use the legacy `serviceAccountKey.json` to move data from the old Firestore to the new one.
